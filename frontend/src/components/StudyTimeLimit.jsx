...
import { Crown, Lock, AlertTriangle, Zap, Star, ArrowRight, Clock, Timer } from 'lucide-react';
import { Link } from 'react-router-dom';
import api from '../utils/axios';

const StudyTimeLimit = ({ onLimitReached, children }) => {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              <h3 className="text-amber-200 font-semibold">
                Study Session Limit Warning
              </h3>
              <p className="text-amber-300/80 text-sm">
                You have {limits.remaining} study session{limits.remaining !== 1 ? 's' : ''} remaining today. 
                {limits.remaining === 0 && ' Upgrade to Pro for unlimited study sessions!'}
              </p>
            </div>
            {limits.remaining === 0 && (
              <Link
          ...
          >
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">
                Study Session Limit Reached
              </h2>
              <p className="text-gray-300 mb-6">
                You've reached your daily limit of 3 study sessions. Upgrade to Study Pro for unlimited study sessions and advanced features!
              </p>

...
const LofiMusicPlayer = () => {
  ...
  // Lofi music tracks (using working audio sources)
  const tracks = [
    {
      name: "Lofi Hip Hop",
      url: "https://www.youtube.com/watch?v=jfKfPfyJRdk",
      stream: "https://www.soundjay.com/misc/sounds/bell-ringing-05.wav", // Placeholder - replace with real lofi stream
      artist: "Chilled Cow",
      isYouTube: true
    },
    {
